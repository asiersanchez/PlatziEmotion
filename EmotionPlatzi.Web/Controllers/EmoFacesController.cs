...
namespace EmotionPlatzi.Web.Controllers
{
    public class EmoFacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmoPictureId,X,Y,Widht,Height")] EmoFace emoFace)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmoPictureId,X,Y,Widht,Height")] EmoFace emoFace)
        {
            if (ModelState.IsValid)
            {
